  ...
  return knex('form').del()
    .then(function () {
      ...
      return knex('form').insert([
        { id: 1, questions: "How do you want to get married?", answers: "['Las Vegas', 'Beach', 'Church']", score: "[3, 2, 1]" },
        { id: 2, questions: "Pizza, Wine and Netflix?", answers: "['On the first Date', 'Saturdays', 'Once a Month']", score: "[1, 2, 3]" },
        { id: 3, questions: "Weapon of choice for a zombie apocalipse?", answers: "['Samurai Sword', 'Shotgun', 'Weapons are heavy, I would run!']", score: "[2, 3, 1]" },
